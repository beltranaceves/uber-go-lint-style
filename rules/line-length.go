...
// LineLengthRule lints line-length according to Uber Go Style Guide.
// Reference: https://github.com/uber-go/guide/blob/master/style.md#line-length
...
func (r *LineLengthRule) Apply(file *lint.File, args lint.Arguments) []lint.Failure {
