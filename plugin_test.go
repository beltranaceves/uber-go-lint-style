...
func TestVarScopeRule(t *testing.T) {
	newPlugin, err := register.GetPlugin("uber-go-lint-style")
	require.NoError(t, err)
	...
	analysistest.Run(t, testdataDir(t), getAnalyzerByName(t, analyzers, "var_scope"), "testlintdata/var_scope")
}
...
func TestTypeAssertRule(t *testing.T) {
	...
	analysistest.Run(t, testdataDir(t), getAnalyzerByName(t, analyzers, "type_assert"), "testlintdata/type_assert")
}
...
func TestTimeUsageRule(t *testing.T) {
	newPlugin, err := register.GetPlugin("uber-go-lint-style")
	require.NoError(t, err)
	...
	analysistest.Run(t, testdataDir(t), getAnalyzerByName(t, analyzers, "time_usage"), "testlintdata/time_usage")
}
...
func TestStructTagRule(t *testing.T) {
	newPlugin, err := register.GetPlugin("uber-go-lint-style")
	require.NoError(t, err)
